...
* **Кейс #4: Бесконтрольное выделение коммерческих ресурсов (Bypass тарифных лимитов в API)**
  * *Суть:* Отсутствие серверной валидации ограничений подписки на эндпоинтах создания сущностей (`POST /v1/firm/create`).
  * *Impact:* Полный обход монетизации платформы. Успешно продемонстрирован оверлим (создание 54 организаций вместо 10 разрешенных), что позволяет бесплатно использовать инфраструктуру сервиса, легитимная стоимость которой составляет до **839 992 руб./год**.
